    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h5 class="card-title text-primary">Nacionalidades</h5>
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-data" id="form-data" novalidate>
                ...
                <input id="id_tipo_catalogo" name="id_tipo_catalogo" value="5" type="hidden">
...
<script>
id_tipo_catalogo=5;
title_modal_data="Registrar Nueva Nacionalidad";
</script>
