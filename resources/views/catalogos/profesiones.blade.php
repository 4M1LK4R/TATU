    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h5 class="card-title text-primary">Profesiones</h5>
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-data" id="form-data" novalidate>
                ...
                <input id="id_tipo_catalogo" name="id_tipo_catalogo" value="4" type="hidden">
...
<script>
id_tipo_catalogo=4;
title_modal_data="Registrar Nuevo Tipo de Profesión";
</script>
