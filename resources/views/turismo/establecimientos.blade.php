    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h5 class="card-title text-primary">Establecimientos</h5>
                    </div>
            ...
            <form class="form-data" id="form-data" novalidate>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="col-md-6" id="select_tipos_establecimientos">
...
@endsection 
@section('scripts')
<script src="{{ URL::asset('js/scripts/establecimientos.js') }}"></script>
